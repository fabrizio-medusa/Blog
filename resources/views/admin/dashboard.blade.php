<x-layout>
    ...
    <div class="container my-5">
        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="text-articles">Richieste per ruolo amministratore</h2>
    ...
    <div class="container my-5">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="text-articles">Richieste per ruolo revisore</h2>
    ...
    <div class="container my-5">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="text-articles">Richieste per ruolo redattore</h2>
    ...
    <div class="container my-5">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="text-articles">I tags della piattaforma</h2>
    ...
    <div class="container my-5">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="text-articles">Le categorie della piattaforma</h2>
                <x-metainfo-table :metaInfos="$categories" metaType="categorie" />
                <form action="{{route('admin.storeCategory')}}" class="d-flex" method="POST">
                    @csrf
                    <input type="text" name="name" class="form-control me-2" placeholder="Inserisci una nuova categoria">
                    <button class="btn btn-success text-white text-articles " type="submit">Aggiungi</button>
                </form>
            </div>
        </div>
    </div>
